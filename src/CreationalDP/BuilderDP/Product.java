...
// Parametreli Const.
    ...
    public Product(ProductBuilder productBuilder) {
        // productBuilder icerisinde kac tane field varsa product icine aktarilacak
    ...
    public static class ProductBuilder{  // bu class uzerinden product objelerim olussun
        private Long id;
        private String name;
        private LocalDateTime date;
        private boolean inStock;
        ...
        public ProductBuilder id(Long id) {  //Getter-setter ile degil ProductBuilder sinifinin degerlerine bunu set edicek
            this.id=id;                      // const. icine class bilgileri gelecek
            return this;
        }
